...
from Experiment1 import RANDOM_VARIABLE_PREDICATE_TYPE, RANDOM_VARIABLE_PREDICATE, DATABASE_NAME, RANDOM_VARIABLE_PREDICATE_RANGE, DECLARATIVE_BIAS_ORDERED, PROLOG_PROGRAM_HEADER, DC_PROGRAM_HEADER, DC_PROGRAM_DATA_DEPENDENT_RELATION
