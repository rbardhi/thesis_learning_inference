...
public class TestExistQuery {
	...
	public static void setUp() throws FeatureTypeException, ConjunctionConstructionProblem{
		...
		dep1=new Dependency(difficulty, new Feature[]{new Exist(conj)});
	}
	...
	public void testDataLoaderNoSelector() throws Exception{
		...
		BoolValue v=(BoolValue) tQrs.getFeatureValue(difficultyc1, engine,dep1.getFeatures().get(0), d.getInterpretations().get(0));
