...
public class TestRenamings {
	...
	@Test
	public void testGettingRenamings() throws Exception{
		AtomCombinationCreator testClass=new AtomCombinationCreator();
		List<ProposedConjunction> prop=testClass.getallPossibleCombinationUpToLength(new Literal[]{new PosLiteral(intelligence),new PosLiteral(grade),new PosLiteral(takes)}, 2, friend, 3,3);
