...
posX_t1(W,Id) ~ gaussian(Mean,0.17533297500955558) := posX_t0(W,Id)~=X_M,displX(W,Id)~=X_M_1,getMean([X_M,X_M_1],[0.8783746117320607,0.9469817886543107,0.30292023547698],Mean).
posX_t1(W,Id) ~ gaussian(2.46595744846,1.45358780442) := true.
posY_t1(W,Id) ~ gaussian(Mean,0.17565351474936164) := posY_t0(W,Id)~=X_M,displY(W,Id)~=X_M_1,getMean([X_M,X_M_1],[0.8790756863097495,0.9382235818641246,0.306602684799119],Mean).
