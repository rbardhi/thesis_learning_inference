...
displ(W,Id) ~ gaussian(Mean,0.035261547844287665) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square,findall_forward(X_M,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id)~=X_M),X_T_13_Temp),avg(X_T_13_Temp)~=X_T_13,getMean([X_T_13],[-0.018826177146329323,0.02600826627402661],Mean).
displ(W,Id) ~ gaussian(Mean,0.7421583307190482) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_23_Temp),avg(X_T_23_Temp)~=X_T_23,getMean([X_M,X_T_23],[-0.6175798569145609,0.19984326185068796,0.7602647710346437],Mean).
displ(W,Id) ~ gaussian(Mean,0.8622327848983347) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_31_Temp),avg(X_T_31_Temp)~=X_T_31,getMean([X_M,X_T_31],[-0.8311704646867483,0.6660259493816475,0.09877266473583335],Mean).
displ(W,Id) ~ gaussian(-0.0243337048126,0.017666834016) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_4),\+maxMod(X_T_4)~=_.
