...
displ(W,Id) ~ gaussian(Mean,0.036079628932629206) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_19_Temp),avg(X_T_19_Temp)~=X_T_19,shape(W,Id_M)~=Sh_M_1,Sh_M_1==square,getMean([X_M,X_T_19],[-0.049935381342657126,0.06356040719051474,0.00023697991392062495],Mean).
displ(W,Id) ~ gaussian(Mean,0.029956179644448633) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_19_Temp),avg(X_T_19_Temp)~=X_T_19,shape(W,Id_M)~=Sh_M_1,Sh_M_1==triangle,getMean([X_M,X_T_19],[-0.049823308592667495,0.052363817604779775,0.02867508098435088],Mean).
displ(W,Id) ~ gaussian(Mean,0.02261920970372447) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_19_Temp),avg(X_T_19_Temp)~=X_T_19,shape(W,Id_M)~=Sh_M_1,Sh_M_1==circle,getMean([X_M,X_T_19],[-0.04563141878141883,0.05385410348618301,0.017500844644980765],Mean).
displ(W,Id) ~ gaussian(Mean,0.7423302213465549) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_27_Temp),avg(X_T_27_Temp)~=X_T_27,getMean([X_M,X_T_27],[-0.6223402541083894,0.19887611637393005,0.7715145634415221],Mean).
displ(W,Id) ~ gaussian(Mean,0.8529954104407538) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_35_Temp),avg(X_T_35_Temp)~=X_T_35,getMean([X_M,X_T_35],[-0.8493629491740998,0.6871638685100783,0.11578986310338157],Mean).
displ(W,Id) ~ gaussian(-0.0252842073139,0.0182689533073) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_4),\+maxMod(X_T_4)~=_.
displ(W,Id) ~ gaussian(-0.449090294122,0.785302431316).
posX_t1(W,Id) ~ gaussian(Mean,3.7498518262121257e-28) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[0.9999999999999992,0.9999999999999992,2.0872192862952943e-14],Mean).
posX_t1(W,Id) ~ gaussian(2.14947971487,1.28929126842).
posY_t1(W,Id) ~ gaussian(Mean,1.356300885605505e-31) := posY_t0(W,Id)~=X_M,getMean([X_M],[1.0000000000000002,-4.440892098500626e-16],Mean).
posY_t1(W,Id) ~ gaussian(2.49039834493,1.79759905307).
