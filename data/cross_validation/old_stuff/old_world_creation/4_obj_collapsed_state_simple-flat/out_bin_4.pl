...
displ(W,Id) ~ gaussian(Mean,0.042749436767189244) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_19_Temp),avg(X_T_19_Temp)~=X_T_19,shape(W,Id_M)~=Sh_M_1,Sh_M_1==square,getMean([X_M,X_T_19],[-0.06287262366746495,0.07841931304672826,0.007629215931220727],Mean).
displ(W,Id) ~ gaussian(Mean,0.03020944337233166) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_19_Temp),avg(X_T_19_Temp)~=X_T_19,shape(W,Id_M)~=Sh_M_1,Sh_M_1==triangle,getMean([X_M,X_T_19],[-0.05463646163062371,0.05763579153142941,0.03274939354859942],Mean).
displ(W,Id) ~ gaussian(Mean,0.02720277530737921) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_19_Temp),avg(X_T_19_Temp)~=X_T_19,shape(W,Id_M)~=Sh_M_1,Sh_M_1==circle,getMean([X_M,X_T_19],[-0.055466659577796625,0.06441971324752199,0.025998322940236834],Mean).
displ(W,Id) ~ gaussian(Mean,0.7478866918901962) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle,posX_t0(W,Id)~=X_M,findall_forward(X_M_1,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id_M)~=X_M_1),X_T_27_Temp),avg(X_T_27_Temp)~=X_T_27,getMean([X_M,X_T_27],[-0.6193956500334373,0.1968524289173055,0.7638116882837831],Mean).
displ(W,Id) ~ gaussian(Mean,0.9963655737752015) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle,findall_forward(X_M,(left_of(W,Id,Id_M)~=true,posX_t0(W,Id)~=X_M),X_T_29_Temp),avg(X_T_29_Temp)~=X_T_29,getMean([X_T_29],[-0.4545105170966928,0.24688478108786427],Mean).
displ(W,Id) ~ gaussian(-0.0237097042056,0.0170733174728) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_4),\+maxMod(X_T_4)~=_.
displ(W,Id) ~ gaussian(-0.450462507238,0.784588027735).
posX_t1(W,Id) ~ gaussian(Mean,3.1378119677847218e-28) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[0.9999999999999997,1.0000000000000004,1.865174681370263e-14],Mean).
posX_t1(W,Id) ~ gaussian(2.14663591882,1.29580060712).
posY_t1(W,Id) ~ gaussian(Mean,3.2901697435486224e-30) := posY_t0(W,Id)~=X_M,getMean([X_M],[1.0000000000000013,-3.1086244689504383e-15],Mean).
posY_t1(W,Id) ~ gaussian(2.4879684567,1.79340027706).
