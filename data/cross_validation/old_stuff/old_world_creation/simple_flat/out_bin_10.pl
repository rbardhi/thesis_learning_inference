...
displ(W,Id) ~ gaussian(-0.0260889941397,0.0189854323635) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square.
displ(W,Id) ~ gaussian(-0.445333195387,0.148141480784) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle.
displ(W,Id) ~ gaussian(-0.574205678666,0.117297126133) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle.
...
displ(W,Id) ~ gaussian(-0.250015225513,0.13190400118).
posX_t1(W,Id) ~ gaussian(Mean,5.693828704987893e-30) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[1.0000000000000007,1.0000000000000002,-1.7763568394002505e-15],Mean).
posX_t1(W,Id) ~ gaussian(2.08188086986,1.02320595139).
posY_t1(W,Id) ~ gaussian(Mean,1.2850401024378015e-31) := posY_t0(W,Id)~=X_M,getMean([X_M],[1.0000000000000002,-4.440892098500626e-16],Mean).
posY_t1(W,Id) ~ gaussian(2.4418277782,1.78505831101).
