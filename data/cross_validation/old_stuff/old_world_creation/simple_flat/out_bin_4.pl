...
displ(W,Id) ~ gaussian(-0.0267157285913,0.019889001542) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square.
displ(W,Id) ~ gaussian(-0.444023679877,0.150857206534) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle.
displ(W,Id) ~ gaussian(-0.575159731042,0.115672268093) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle.
...
displ(W,Id) ~ gaussian(-0.250259978213,0.132210050478).
posX_t1(W,Id) ~ gaussian(Mean,5.059360532025097e-30) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[1.0000000000000002,1.0000000000000007,-4.440892098500626e-16],Mean).
posX_t1(W,Id) ~ gaussian(2.06835769561,1.0290038812).
posY_t1(W,Id) ~ gaussian(Mean,1.2943490611021338e-31) := posY_t0(W,Id)~=X_M,getMean([X_M],[1.0000000000000002,-4.440892098500626e-16],Mean).
posY_t1(W,Id) ~ gaussian(2.44708490226,1.79870706344).
