...
displ(W,Id) ~ gaussian(-0.0249107051659,0.0183546853427) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square.
displ(W,Id) ~ gaussian(-0.450666562481,0.150773949665) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle.
displ(W,Id) ~ gaussian(-0.574072330788,0.116181037208) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle.
...
displ(W,Id) ~ gaussian(-0.250481515829,0.132388859265).
posX_t1(W,Id) ~ gaussian(Mean,9.839843697032803e-30) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[1.0000000000000004,1.0,-3.1086244689504383e-15],Mean).
posX_t1(W,Id) ~ gaussian(2.06779497362,1.01801931536).
posY_t1(W,Id) ~ gaussian(Mean,1.2980247014331146e-31) := posY_t0(W,Id)~=X_M,getMean([X_M],[0.9999999999999998,4.440892098500626e-16],Mean).
posY_t1(W,Id) ~ gaussian(2.44855091916,1.78751002256).
