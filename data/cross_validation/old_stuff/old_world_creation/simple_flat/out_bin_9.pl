...
displ(W,Id) ~ gaussian(-0.0262497576408,0.0192027051184) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square.
displ(W,Id) ~ gaussian(-0.441806584624,0.150840013367) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle.
displ(W,Id) ~ gaussian(-0.578189711642,0.114951671057) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle.
...
displ(W,Id) ~ gaussian(-0.250368603469,0.132239078622).
posX_t1(W,Id) ~ gaussian(Mean,1.1494401372621937e-29) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[1.0000000000000007,0.9999999999999997,-3.9968028886505635e-15],Mean).
posX_t1(W,Id) ~ gaussian(2.06929753482,1.01685444213).
posY_t1(W,Id) ~ gaussian(Mean,9.731614496024649e-32) := posY_t0(W,Id)~=X_M,getMean([X_M],[0.9999999999999999,4.440892098500626e-16],Mean).
posY_t1(W,Id) ~ gaussian(2.44948557133,1.7951315408).
