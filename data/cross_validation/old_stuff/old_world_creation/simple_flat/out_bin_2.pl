...
displ(W,Id) ~ gaussian(-0.0256038823507,0.019253295019) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square.
displ(W,Id) ~ gaussian(-0.443434778867,0.152157825188) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle.
displ(W,Id) ~ gaussian(-0.57871580765,0.115156854567) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle.
...
displ(W,Id) ~ gaussian(-0.251184592527,0.13296120298).
posX_t1(W,Id) ~ gaussian(Mean,5.428211324614836e-30) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[1.0,1.0000000000000002,-4.440892098500626e-16],Mean).
posX_t1(W,Id) ~ gaussian(2.07780827451,1.02994334312).
posY_t1(W,Id) ~ gaussian(Mean,1.2857192968467873e-31) := posY_t0(W,Id)~=X_M,getMean([X_M],[1.0000000000000002,-4.440892098500626e-16],Mean).
posY_t1(W,Id) ~ gaussian(2.44720310601,1.79705178739).
