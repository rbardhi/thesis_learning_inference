...
displ(W,Id) ~ gaussian(-0.0242731079349,0.0184643338662) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square.
displ(W,Id) ~ gaussian(-0.444313062679,0.150630524196) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle.
displ(W,Id) ~ gaussian(-0.582098983201,0.114195511165) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle.
...
displ(W,Id) ~ gaussian(-0.250817573203,0.132712871491).
posX_t1(W,Id) ~ gaussian(Mean,6.753761806351103e-30) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[1.0000000000000007,0.9999999999999991,-2.6645352591003757e-15],Mean).
posX_t1(W,Id) ~ gaussian(2.07708874788,1.02424133076).
posY_t1(W,Id) ~ gaussian(Mean,0.0) := posY_t0(W,Id)~=X_M,getMean([X_M],[1.0,0.0],Mean).
posY_t1(W,Id) ~ gaussian(2.44641301678,1.79025580905).
