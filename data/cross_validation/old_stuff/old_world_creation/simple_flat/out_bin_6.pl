...
displ(W,Id) ~ gaussian(-0.0253828586809,0.0186329561769) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_1),maxMod(X_T_1)~=square.
displ(W,Id) ~ gaussian(-0.447777358912,0.150975454926) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_2),maxMod(X_T_2)~=triangle.
displ(W,Id) ~ gaussian(-0.575017163781,0.114918857647) := findall_forward(Sh_M,(left_of(W,Id,Id_M)~=true,shape(W,Id)~=Sh_M),X_T_3),maxMod(X_T_3)~=circle.
...
displ(W,Id) ~ gaussian(-0.250166366075,0.131994987562).
posX_t1(W,Id) ~ gaussian(Mean,1.2205681724540272e-29) := posX_t0(W,Id)~=X_M,displ(W,Id)~=X_M_1,getMean([X_M,X_M_1],[0.9999999999999997,1.0,-1.7763568394002505e-15],Mean).
posX_t1(W,Id) ~ gaussian(2.08796865061,1.01925886558).
posY_t1(W,Id) ~ gaussian(Mean,3.5208396540136267e-31) := posY_t0(W,Id)~=X_M,getMean([X_M],[1.0000000000000004,-8.881784197001252e-16],Mean).
posY_t1(W,Id) ~ gaussian(2.45261711068,1.79935176662).
