...
move_left_of(W,Id,Id1) ~ finite([0.05920114122681883:true,0.9407988587731811:false]) := left_of(W,Id,Id1)~=B_M,B_M==true,shape(W,Id)~=Sh_M,Sh_M==square,shape(W,Id1)~=Sh_M_1,Sh_M_1==triangle.
move_left_of(W,Id,Id1) ~ finite([0.0987189148455162:true,0.9012810851544838:false]) := left_of(W,Id,Id1)~=B_M,B_M==true,shape(W,Id)~=Sh_M,Sh_M==square,shape(W,Id1)~=Sh_M_1,Sh_M_1==circle.
move_left_of(W,Id,Id1) ~ finite([0.20751173708920187:true,0.7924882629107981:false]) := left_of(W,Id,Id1)~=B_M,B_M==true,shape(W,Id)~=Sh_M,Sh_M==triangle.
move_left_of(W,Id,Id1) ~ finite([0.20186781609195403:false,0.798132183908046:true]) := \+left_of(W,Id,Id1)~=B_M,shape(W,Id)~=Sh_M,Sh_M==square,shape(W,Id1)~=Sh_M_1,Sh_M_1==triangle.
...
move_left_of(W,Id,Id1) ~ finite([0.6164305949008498:true,0.38356940509915016:false]) := \+left_of(W,Id,Id1)~=B_M,shape(W,Id)~=Sh_M,Sh_M==triangle.
move_left_of(W,Id,Id1) ~ finite([0.43352601156069365:true,0.5664739884393064:false]).
displ(W,Id) ~ gaussian(Mean,0.05488854739653652) := move_left_of(W,Id_M,Id)~=true,true==true,posX_t0(W,Id)~=X_M,posX_t0(W,Id_M)~=X_M_1,getMean([X_M,X_M_1],[-0.9777862061161879,0.9430689100780115,-0.8070507407521779],Mean).
displ(W,Id) ~ gaussian(Mean,0.024333483589568952) := \+move_left_of(W,Id_M,Id)~=true,posX_t0(W,Id)~=X_M,getMean([X_M],[-0.01641628666424319,0.018171446682420808],Mean).
