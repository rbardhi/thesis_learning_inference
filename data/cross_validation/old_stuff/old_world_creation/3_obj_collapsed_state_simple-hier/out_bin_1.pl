...
displ(W,Id) ~ gaussian(Mean,0.05486987288897164) := move_left_of(W,Id_M,Id)~=true,true==true,posX_t0(W,Id)~=X_M,posX_t0(W,Id_M)~=X_M_1,getMean([X_M,X_M_1],[-0.9803337141486205,0.9432770261346455,-0.7996506780612436],Mean).
displ(W,Id) ~ gaussian(Mean,0.027546963579136177) := \+move_left_of(W,Id_M,Id)~=true,posX_t0(W,Id)~=X_M,getMean([X_M],[-0.018397014069726613,0.021313128247369785],Mean).
