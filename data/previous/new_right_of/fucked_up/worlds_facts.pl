...
:- discontiguous move_right_ofX/4.
:- discontiguous move_right_ofY/4.
...
%Dynamics
:- dynamic shape/3.
:- dynamic move_right_ofX/4.
:- dynamic move_right_ofY/4.
:- dynamic posX_t0/3.
:- dynamic posX_t1/3.
:- dynamic posY_t0/3.
:- dynamic posY_t1/3.
...
%Types
base(shape(w,i,sh)).
base(move_right_ofX(w,i,i,x)).
base(move_right_ofY(w,i,i,x)).
base(posX_t0(w,i,x)).
base(posX_t1(w,i,x)).
base(posY_t0(w,i,x)).
base(posY_t1(w,i,x)).
...
%Modes
mode(move_right_ofX,none,shape(+,+,-)).
mode(move_right_ofX,none,posX_t0(+,+,-)).
mode(move_right_ofX,none,posX_t1(+,+,-)).
mode(move_right_ofX,none,blocked_t0(+,+,-)).
mode(move_right_ofX,none,front_of_t0(+,+,-)).
mode(move_right_ofX,none,right_of_t0(+,+,-)).
mode(move_right_ofX,none,behind_of_t0(+,+,-)).
mode(move_right_ofX,none,left_of_t0(+,+,-)).

mode(move_right_ofY,none,shape(+,+,-)).
mode(move_right_ofY,none,posY_t0(+,+,-)).
mode(move_right_ofY,none,posY_t1(+,+,-)).
mode(move_right_ofY,none,blocked_t0(+,+,-)).
mode(move_right_ofY,none,front_of_t0(+,+,-)).
mode(move_right_ofY,none,right_of_t0(+,+,-)).
mode(move_right_ofY,none,behind_of_t0(+,+,-)).
mode(move_right_ofY,none,left_of_t0(+,+,-)).
...
thres(move_right_ofX, 4, continuous, []).
thres(move_right_ofY, 4, continuous, []).
...
%Targets
learn(move_right_ofX, 4, 4, continuous).
learn(move_right_ofY, 4, 4, continuous).
...
left_of_t0(0,1,0).
blocked_t0(0,1,left).
move_right_ofX(0,0,1,-2.324251).
move_right_ofY(0,0,1,-1.219050).
%Timestep 1
...
move_right_ofX(10000,0,1,-3.032619).
move_right_ofY(10000,0,1,-0.513204).
%Timestep 1
...
move_right_ofX(20000,0,1,-2.325593).
move_right_ofY(20000,0,1,0.193984).
%Timestep 1
...
move_right_ofX(30000,0,1,-1.613464).
move_right_ofY(30000,0,1,0.906113).
%Timestep 1
...
move_right_ofX(40000,0,1,-2.324677).
move_right_ofY(40000,0,1,1.609114).
%Timestep 1
...
move_right_ofX(50000,0,1,-1.621401).
move_right_ofY(50000,0,1,2.320052).
%Timestep 1
...
move_right_ofX(60000,0,1,-0.920754).
move_right_ofY(60000,0,1,3.020698).
%Timestep 1
...
move_right_ofX(2,0,1,1.134868).
move_right_ofY(2,0,1,2.570783).
%Timestep 1
...
move_right_ofX(3,0,1,-0.067756).
move_right_ofY(3,0,1,2.888861).
%Timestep 1
...
blocked_t0(4,1,left).
move_right_ofX(4,0,1,-0.300238).
move_right_ofY(4,0,1,3.596230).
%Timestep 1
...
move_right_ofX(10004,0,1,0.410098).
move_right_ofY(10004,0,1,4.306566).
%Timestep 1
...
blocked_t0(6,0,left).
move_right_ofX(6,0,1,-3.628016).
move_right_ofY(6,0,1,-1.053334).
%Timestep 1
...
move_right_ofX(10006,0,1,-2.921431).
move_right_ofY(10006,0,1,-0.345705).
%Timestep 1
...
move_right_ofX(20006,0,1,-2.216473).
move_right_ofY(20006,0,1,0.359252).
%Timestep 1
...
move_right_ofX(30006,0,1,-2.917841).
move_right_ofY(30006,0,1,-0.342116).
%Timestep 1
...
move_right_ofX(40006,0,1,-3.622394).
move_right_ofY(40006,0,1,0.367544).
%Timestep 1
...
move_right_ofX(50006,0,1,-4.336572).
move_right_ofY(50006,0,1,1.081722).
%Timestep 1
...
move_right_ofX(60006,0,1,-3.629717).
move_right_ofY(60006,0,1,1.789080).
%Timestep 1
...
move_right_ofX(70006,0,1,-4.339714).
move_right_ofY(70006,0,1,2.493296).
%Timestep 1
...
move_right_ofX(80006,0,1,-3.625568).
move_right_ofY(80006,0,1,3.193363).
%Timestep 1
...
move_right_ofX(11,0,1,2.154769).
move_right_ofY(11,0,1,-1.625961).
%Timestep 1
...
move_right_ofX(10011,0,1,2.866974).
move_right_ofY(10011,0,1,-0.913756).
%Timestep 1
...
move_right_ofX(20011,0,1,3.568369).
move_right_ofY(20011,0,1,-1.626575).
%Timestep 1
...
move_right_ofX(30011,0,1,4.270779).
move_right_ofY(30011,0,1,-0.914771).
%Timestep 1
...
move_right_ofX(12,0,1,-3.753666).
move_right_ofY(12,0,1,-1.169867).
%Timestep 1
...
move_right_ofX(10012,0,1,-4.462842).
move_right_ofY(10012,0,1,-0.460690).
%Timestep 1
...
move_right_ofX(20012,0,1,-3.750928).
move_right_ofY(20012,0,1,0.241608).
%Timestep 1
...
move_right_ofX(30012,0,1,-3.050354).
move_right_ofY(30012,0,1,0.942182).
%Timestep 1
...
move_right_ofX(40012,0,1,-2.345963).
move_right_ofY(40012,0,1,1.646573).
%Timestep 1
...
move_right_ofX(50012,0,1,-1.643017).
move_right_ofY(50012,0,1,2.349519).
%Timestep 1
...
move_right_ofX(60012,0,1,-0.938612).
move_right_ofY(60012,0,1,3.053924).
%Timestep 1
...
move_right_ofX(13,0,1,-0.441579).
move_right_ofY(13,0,1,0.734461).
%Timestep 1
...
move_right_ofX(14,0,1,2.492223).
move_right_ofY(14,0,1,1.730305).
%Timestep 1
...
move_right_ofX(10014,0,1,3.200664).
move_right_ofY(10014,0,1,2.436077).
%Timestep 1
...
move_right_ofX(20014,0,1,3.904579).
move_right_ofY(20014,0,1,1.725778).
%Timestep 1
...
move_right_ofX(30014,0,1,4.613992).
move_right_ofY(30014,0,1,2.430579).
%Timestep 1
...
move_right_ofX(15,0,1,-0.865983).
move_right_ofY(15,0,1,2.792901).
%Timestep 1
...
behind_of_t0(16,0,1).
left_of_t0(16,1,0).
move_right_ofX(16,0,1,1.200138).
move_right_ofY(16,0,1,0.638672).
%Timestep 1
...
move_right_ofX(10016,0,1,1.909695).
move_right_ofY(10016,0,1,1.348230).
%Timestep 1
...
move_right_ofX(20016,0,1,2.623719).
move_right_ofY(20016,0,1,2.062253).
%Timestep 1
...
move_right_ofX(17,0,1,3.944550).
move_right_ofY(17,0,1,-2.261845).
%Timestep 1
...
move_right_ofX(10017,0,1,4.653490).
move_right_ofY(10017,0,1,-1.552905).
%Timestep 1
...
move_right_ofX(20017,0,1,5.358117).
move_right_ofY(20017,0,1,-0.848278).
%Timestep 1
...
move_right_ofX(18,0,1,-0.688917).
move_right_ofY(18,0,1,-1.052184).
%Timestep 1
...
move_right_ofX(10018,0,1,0.022634).
move_right_ofY(10018,0,1,-0.349521).
%Timestep 1
...
move_right_ofX(20018,0,1,0.732702).
move_right_ofY(20018,0,1,0.360547).
%Timestep 1
...
move_right_ofX(30018,0,1,1.442875).
move_right_ofY(30018,0,1,1.070721).
%Timestep 1
...
move_right_ofX(40018,0,1,2.155538).
move_right_ofY(40018,0,1,1.783384).
%Timestep 1
