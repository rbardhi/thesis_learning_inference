...
displX(W,Id) ~ gaussian(Mean,0.0659757697294462) := almove_left_of(W,Id)~=X_M,posX_t0(W,Id)~=X_M_1,getMean([X_M,X_M_1],[0.9897989345137728,-1.0170289793917004,-0.7735772515608728],Mean).
displX(W,Id) ~ gaussian(0.0,0.0) := \+almove_left_of(W,Id)~=X_M.
displX(W,Id) ~ gaussian(-0.454285244008,0.803036202528) := true.
posX_t1(W,Id) ~ gaussian(Mean,0.0023835705683812615) := posX_t0(W,Id)~=X_M,displX(W,Id)~=X_M_1,getMean([X_M,X_M_1],[0.9984763831815588,0.9972423896972357,0.0022358853551520674],Mean).
